...
def is_valid_ip_address(ipstr : str) -> bool:
    """
        Check if the given ipstr is valid
        Args : 
            ipstr : str
        Returns : bool
    """
...
def is_same_primary_domain(domain1 : str, domain2 : str) -> bool:
    """
        Check if the given domain1 and domain2 are the same
        Args : 
            domain1 : str
            domain2 : str
        Returns : bool
...
def parse_origin_from_url(url : str) -> str | None:
    """
        Parse the origin from a URL
        Args:
            url : str
        Returns: str | None
    """
