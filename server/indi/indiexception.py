...
class INDICameraError(Enum):
    """
        Regular INDI camera error
    """
...
class INDICameraSuccess(Enum):
    """
        Regular INDI camera success
    """
...
class INDICameraWarning(Enum):
    """
        Regular INDI camera warning
    """
