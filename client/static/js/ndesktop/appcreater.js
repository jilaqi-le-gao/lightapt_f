...
function buildapp(appname, icon, visualappname) {
  ...
  minimizedivimage.src = "/static/textures/ndesktop/minimize.png";
  ...
  maximizedivimage.src = "/static/textures/ndesktop/maximize.png";
  ...
  restoredivimage.src = "/static/textures/ndesktop/restore.png";
  ...
  closedivimage.src = "/static/textures/ndesktop/close.png";
...
function makeappusable(appname, website) {
  ...
  function goToPage(pageUrl) {
    if (appname == "edge" || appname == "terminal") {
      return;
    }
  ...
  close.addEventListener("click", () => {
    ...
    if (appname == "edge" || appname == "lightapt") {
      void 0;
    } else {
